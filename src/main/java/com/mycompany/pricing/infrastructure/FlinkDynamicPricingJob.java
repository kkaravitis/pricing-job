...
public class FlinkDynamicPricingJob {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DemandMetricsProviderAdapter demandMetricsProviderAdapter = feedFlinkDemandMetricsProvider(clicks);
        // collect inventory level per product.
        InventoryProviderAdapter inventoryProviderAdapter = feedFlinkInventoryProvider(env);
        // collect competitors price per product.
        CompetitorPriceProviderAdapter priceProviderAdapter = feedFlinkCompetitorPriceProvider(clicks);
        // collect product price rule.
        PriceRuleProviderAdapter ruleProviderAdapter = feedFlinkPriceRuleProvider(env);
    ...
    private static DemandMetricsProviderAdapter feedFlinkDemandMetricsProvider(DataStream<ClickEvent> clicks) {
        ...
        DemandMetricsProviderAdapter demandMetricsProviderAdapter = new DemandMetricsProviderAdapter();
        demandMetricsStream
              .keyBy(DemandMetrics::getProductId)
        ...
        return demandMetricsProviderAdapter;
    }

    private static InventoryProviderAdapter feedFlinkInventoryProvider(StreamExecutionEnvironment env) {
        ...
        InventoryProviderAdapter invProv = new InventoryProviderAdapter();
        inventoryStream
    ...
    private static CompetitorPriceProviderAdapter feedFlinkCompetitorPriceProvider(DataStream<ClickEvent> clicks) {
        ...
        CompetitorPriceProviderAdapter priceProv = new CompetitorPriceProviderAdapter();
        compPrices
    ...
    private static PriceRuleProviderAdapter feedFlinkPriceRuleProvider(StreamExecutionEnvironment env) {
        ...
        PriceRuleProviderAdapter ruleProv = new PriceRuleProviderAdapter();
